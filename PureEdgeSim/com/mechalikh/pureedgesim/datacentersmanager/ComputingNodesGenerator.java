...
public class ComputingNodesGenerator {
	 ...
	 * orchestrators are deployed to computing nodes. In this case, the tasks are
	...
	private ComputingNode createComputingNode(Element datacenterElement, SimulationParameters.TYPES type)
		...
		SimLog.println(String.valueOf(type));
		...
		SimLog.println("computingNode" + String.valueOf(computingNode));
